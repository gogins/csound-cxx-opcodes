...
g++ -v -Xlinker -g -O2 -fPIC -Wl,-export-dynamic -shared `llvm-config-13 --cxxflags --ldflags` -I/usr/local/include -I/usr/local/include/csound clang_opcodes.cpp $CLANGLIBS2 `llvm-config-13 --libs --system-libs` -o clang_opcodes.so
ls -ll
