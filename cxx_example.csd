...
cxx_example.csd - demonstrates and tests the new C++ compiler opcodes for Csound.

To facilitate understanding how this .csd file uses the cxx opcodes, all 
...
This file is part of cxx-opcodes.
...
cxx-opcodes is distributed in the hope that it will be useful,
...
a_left, a_right cxx_invoke "guitar_factory", 3, i_frequency, 0, gk_ClangGuitar_gain, 0, gk_ClangGuitar_shape, gk_ClangGuitar_scale, 0, gk_ClangGuitar_pluck_position, gk_ClangGuitar_outGain, 1
