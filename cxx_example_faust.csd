...
/************************************************************************
 ...
 the License, or (at yhow to use several independent llvmcontextsour option) any later version.
...
/**
 * The rest of the code in this module replaces code generated by Faust for 
 * the Csound opcode architecture with code written by me for the Csound 
 * `cxx_invoke` architecture.
 */

#include "cxx_invokable.hpp"

class InvokableGuitar : public CxxInvokableBase {
...
public:
    int init(CSOUND *csound, OPDS *opds_, MYFLT **outputs, MYFLT **inputs) override {
        ...
        int result = OK;
        result = CxxInvokableBase::init(csound, opds_, outputs, inputs);
        DSP = new mydsp;
...
extern "C" {
    int guitar_main(CSOUND *csound) {
        int result = OK;
        if (diagnostics_enabled) csound->Message(csound, ">>>>>>> This is \\"guitar_main\\" with csound: %p.\\n", csound);
        return result;   
    }     
...
; i_result cxx_compile "guitar_main", S_guitar_source_code, "-g -v -O2 -fPIC -shared -std=c++14 -stdlib=libc++ -I/usr/local/include/csound -I/Library/Frameworks/CsoundLib64.framework/Versions/6.0/Headers -I/opt/homebrew/cellar/faust/2.37.3/include -I. -L/opt/homebrew/lib -lfaust -lm -lpthread"

gk_CxxGuitar_level chnexport "gk_CxxGuitar_level", 3
gk_CxxGuitar_shape chnexport "gk_CxxGuitar_shape", 3
gk_CxxGuitar_scale chnexport "gk_CxxGuitar_scale", 3
gk_CxxGuitar_pluck_position chnexport "gk_CxxGuitar_pluck_position", 3
gk_CxxGuitar_gain chnexport "gk_CxxGuitar_gain", 3
gk_CxxGuitar_otuGain chnexport "gk_CxxGuitar_outGain", 3
gk_CxxGuitar_level init 6
gk_CxxGuitar_shape init .724
gk_CxxGuitar_scale init .02
gk_CxxGuitar_pluck_position init .65
gk_CxxGuitar_gain init .75
gk_CxxGuitar_outGain init .5
...
k_gain = ampdb(gk_CxxGuitar_level)
a_left, a_right cxx_invoke "guitar_factory", 3, i_frequency, 0, gk_CxxGuitar_gain, 0, gk_CxxGuitar_shape, gk_CxxGuitar_scale, 0, gk_CxxGuitar_pluck_position, gk_CxxGuitar_outGain, 1
