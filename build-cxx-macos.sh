...
which clang++
clang++ -v -g -O2 -fPIC -shared `/opt/homebrew/cellar/llvm/13.0.1/bin/llvm-config --cxxflags --ldflags` -I/usr/local/include -I/usr/local/include/csound -I/Library/Frameworks/CsoundLib64.framework/Headers cxx_opcodes.cpp ${CLANGLIBS2} `/opt/homebrew/cellar/llvm/13.0.1/bin/llvm-config --libs --system-libs` -o cxx_opcodes.dylib
ls -ll
