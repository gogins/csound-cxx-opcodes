...
i_result clang_compile "reverb_main", S_reverb_code, "-g -O2 -std=c++14 -I/usr/local/include/csound  -I. -stdlib=libstdc++", "/usr/lib/gcc/x86_64-linux-gnu/9/libstdc++.so /usr/lib/gcc/x86_64-linux-gnu/9/libgcc_s.so /usr/local/lib/libstk.so /usr/lib/x86_64-linux-gnu/libm.so /usr/lib/x86_64-linux-gnu/libpthread.so"
...
aleft, aright clang_invoke "reverb_factory", 3, gk_MasterOutput_reverb_T60, aleft_in, aright_in
